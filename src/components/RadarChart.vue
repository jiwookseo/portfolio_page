...
const labURL = `https://lab.ssafy.com/api/v4/projects/7508/repository/commits/?private_token=`+process.env.VUE_APP_ACCESS_TOKKEN+'&per_page=100';
...
export default {
  ...
  methods: {
    getData() {
      axios.defaults.baseURL = `https://lab.ssafy.com/api/v4/projects/7508/repository/commits/?private_token=`+process.env.VUE_APP_ACCESS_TOKKEN+'&per_page=100';
      axios
        .get(labURL)
        .then(response => {
          gtcount = 0;
